set terminal wxt enhanced title "analysismodel.out" ;
...
unset x2tics;
unset x2tics;
set title "Model" font "Arial,10" noenhanced;
...
unset y2tics;
unset my2tics;
set xrange [0.5:49] noreverse;
set yrange [0.001:16.669790] reverse;
...
plot "analysismodel.out" binary  format="%float%*2float"  array=49x2827 scan=yx  skip=344 origin=(1,0) dx=1 dy=0.005897 using 1 with image