set terminal wxt enhanced title "analysismodel.sca" ;
...
plot "analysismodel.sca" binary  format="%float%*2float"  array=49x2827 scan=yx  skip=344 origin=(1,0) dx=1 dy=0.005897 using 1 with image