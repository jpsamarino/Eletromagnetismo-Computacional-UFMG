set terminal wxt enhanced title "teste1" ;
...
unset y2tics;
unset my2tics;
set xrange [0.5:1] noreverse;
set yrange [0.001:8.001735] reverse;
...
plot "teste1" binary  format="%float%*2float"  array=1x1357 scan=yx  skip=49208 origin=(1,0) dx=1 dy=0.005897 using 1 with image