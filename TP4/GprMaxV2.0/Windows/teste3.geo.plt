set terminal wxt noenhanced title "teste3.geo";
set size ratio -1;
unset label;
unset xtics;
unset ytics;
...
unset x2tics;
unset y2tics;
set title "3.3" font "Arial,10" noenhanced;
...
set cbrange [1:3];
set cbtics ("pec" 1,"free_space" 2,"sea_water" 3) font "Arial,8";
unset key;
set palette defined (1 "black",2 "white",3 "sandybrown");
set mouse format "%.2f"
plot "teste3.geo" binary array=600x600 format="%short" skip=378 scan=yx dx=0.001000 dy=0.001000 using 1 with image;