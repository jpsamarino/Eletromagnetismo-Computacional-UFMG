set terminal wxt noenhanced title "teste4.geo";
set size ratio -1;
unset label;
unset xtics;
unset ytics;
...
unset x2tics;
unset y2tics;
set title "Modelo 3.3" font "Arial,10" noenhanced;
...
unset my2tics;
set xrange [-0.001:5.000000] ;
set yrange [-0.001:5.000000];
set y2range [-0.001:5.000000] reverse;
set cbrange [1:3];
set cbtics ("pec" 1,"free_space" 2,"concrete" 3) font "Arial,8";
unset key;
set palette defined (1 "black",2 "white",3 "sandybrown");
set mouse format "%.2f"
plot "teste4.geo" binary array=2000x2000 format="%short" skip=378 scan=yx dx=0.002500 dy=0.002500 using 1 with image;